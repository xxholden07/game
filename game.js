...
// Configurações dos balcões
const NUM_BARS = 4;
const BAR_HEIGHT = canvas.height / NUM_BARS;
const BARTENDER_X = 50;
...
class Bartender {
    constructor(barIndex) {
        ...
        this.x = BARTENDER_X;
        this.y = barIndex * BAR_HEIGHT + BAR_HEIGHT / 2;
        this.width = 40;
        this.height = 60;
        this.moveSpeed = 5;
        this.armAnimation = 0;
    ...
    update() {
        const speed = hasPower('speed') ? this.moveSpeed * 1.5 : this.moveSpeed;
        const targetY = this.targetBarIndex * BAR_HEIGHT + BAR_HEIGHT / 2;
...
class Customer {
    constructor(barIndex) {
        ...
        this.walkCycle = 0;
        this.happiness = 1;
        this.throwPoint = canvas.width * 0.6;
    ...
    update() {
        ...
        // Movimento em zigue-zague para clientes bêbados
        if (this.type === 'drunk') {
            this.wobble += 0.1;
